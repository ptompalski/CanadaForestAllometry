...
- age:
  ...
  is emitted when \`age \> 60\`, because that exceeds the published
  range.
...
plantation ages up to 60 years. This implementation warns when \`age \>
60\` and returns extrapolated values.
...
Prégent, G., Picher, G., & Auger, I. (2010). *Tarif de cubage, tables de
rendement et modèles de croissance pour les plantations d'épinette
blanche au Québec*. Mémoire de recherche forestière no 160. Gouvernement
du Québec, ministère des Ressources naturelles et de la Faune.
